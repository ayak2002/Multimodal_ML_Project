...
from diverse_channel_vit_version_1.helper_classes.channel_initialization import ChannelInitialization
...
class Model:
    ...
    # New parameters for robust novel channel handling
    novel_channel_strategy: Optional[str] = "dynamic_features"  # Strategy for handling novel channels
    similarity_threshold: Optional[float] = 0.6  # Threshold for similarity matching
    emb_interp_factor: Optional[float] = 0.7  # Interpolation factor between static and dynamic embeddings
    use_channel_adaptation: Optional[bool] = False  # Whether to use additional channel adaptation layer
    channel_diversity_reg: Optional[bool] = False  # Whether to use channel diversity regularization
    diversity_weight: Optional[float] = 0.1  # Weight for diversity regularization loss
    store_attention_maps: Optional[bool] = False  # Whether to store attention maps for visualization
    update_channel_bank: Optional[bool] = True  # Whether to update channel bank during training
