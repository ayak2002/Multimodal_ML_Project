...
subset_indices_within_cp = [9, 11, 10]  # for example
...
cfg.eval.dest_dir = f"/projectnb/cs598/projects/Modalities_Robustness/adaptive_channel_strategy/results/subset_eval_cp{'_'.join(map(str, selected_channels))}"
