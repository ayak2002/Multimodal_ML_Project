...
python main.py -m -cn chammi_cfg \
  ...
  ++logging.wandb.run_name=DiChaViT-Disentanglement-Allen_CP \
  ++model.hcs_sampling=lowest_cosine_prob \
  ++train.checkpoints=/projectnb/cs598/students/ayak/multimodal_tests/checkpoints \
  ++eval.dest_dir=/projectnb/cs598/students/ayak/multimodal_tests/results/disentanglement_test_Allen_CP_${TIMESTAMP}/results \
  ++eval.feature_dir=/projectnb/cs598/students/ayak/multimodal_tests/features/disentanglement_test_Allen_CP_${TIMESTAMP}/features \
