...
# Load miniconda module and activate the dichavit environment
module load miniconda
conda activate dichavit

# Set the Python path to include the project directories
# Make sure your directory comes FIRST in the path so it's found before the original
export PYTHONPATH=/projectnb/cs598/students/ayak/diverse_channel_vit:/projectnb/cs598/students/ayak:$PYTHONPATH
...
export WANDB_PROJECT=dichavit_disentanglement
...
python main.py -m -cn chammi_cfg \
  ...
  ++logging.wandb.run_name=DiChaViT-Disentanglement-Allen_HPA \
  ++model.hcs_sampling=lowest_cosine_prob \
  ++train.checkpoints=/projectnb/cs598/students/ayak/multimodal_tests/checkpoints \
  ++eval.dest_dir=/projectnb/cs598/students/ayak/multimodal_tests/results/disentanglement_test_Allen_HPA_${TIMESTAMP}/results \
  ++eval.feature_dir=/projectnb/cs598/students/ayak/multimodal_tests/features/disentanglement_test_Allen_HPA_${TIMESTAMP}/features \
  ++eval.root_dir=/projectnb/cs598/projects/Modalities_Robustness/channel_adaptive_models/chammi_dataset/CHAMMI \
  ...
  ++logging.wandb.project=dichavit_disentanglement \
  ++logging.wandb.entity=ayak-boston-university \
  ++logging.wandb.log_freq=20 \
