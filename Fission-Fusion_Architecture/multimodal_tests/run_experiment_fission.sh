...
python main.py -m -cn chammi_cfg \
  ...
  ++train.seed=2025 \
  ++logging.wandb.run_name=DiChaViT-Disentanglement \
  ++model.hcs_sampling=lowest_cosine_prob \
  ++train.checkpoints=/projectnb/cs598/students/ayak/multimodal_tests/checkpoints \
  ++eval.dest_dir=/projectnb/cs598/students/ayak/multimodal_tests/results/disentanglement_test_${TIMESTAMP}/results \
  ++eval.feature_dir=/projectnb/cs598/students/ayak/multimodal_tests/features/disentanglement_test_${TIMESTAMP}/features \
