...
python /projectnb/cs598/projects/Modalities_Robustness/adaptive_channel_strategy_aya/diverse_channel_vit/main.py -m \
  ...
  ++train.seed=2025 \
  ++logging.wandb.run_name=Adaptive-DiChaViT-FAN-Allen-HPA \
  ++model.hcs_sampling=lowest_cosine_prob \
  ++train.training_chunks="Allen_HPA" \
  ++train.checkpoints=/projectnb/cs598/projects/Modalities_Robustness/adaptive_channel_strategy_aya/checkpoints/Allen_HPA_adaptive \
  ++eval.dest_dir=/projectnb/cs598/projects/Modalities_Robustness/adaptive_channel_strategy_aya/results/Allen_HPA_adaptive_${TIMESTAMP}/results \
  ++eval.feature_dir=/projectnb/cs598/projects/Modalities_Robustness/adaptive_channel_strategy_aya/features/Allen_HPA_adaptive_${TIMESTAMP}/features \
  ...
  ++logging.wandb.project=adaptive_dichavit_FAN_test_Allen_HPA \
