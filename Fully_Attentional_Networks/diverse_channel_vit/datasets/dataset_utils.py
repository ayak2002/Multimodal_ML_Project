...
def get_train_val_test_loaders(
    ...
    **kwargs,
    ...
    if dataset in ["cifar10", "cifar100"]:
    ...
    elif dataset in ["Allen", "CP", "HPA", "morphem70k", "morphem70k_v2"]:
        ...
        test_set = SingleCellDataset(
            ...
            is_train=False,
            ssl_flag=ssl_flag,
            include_labels=True,  # <--- ADD THIS 4/6
...
def get_classes(dataset: str, file_name: str, training_chunks: List[str] | None = None) -> Tuple:
    if dataset in ["cifar10", "cifar100"]:
        ...
        if dataset == "Allen":
            ...
            train_classes = cp
        #elif dataset == "morphem70k":
        elif dataset in ["morphem70k", "morphem70k_v2"]:
