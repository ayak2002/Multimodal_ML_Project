...
python main.py -m -cn chammi_cfg \
  ...
  ++train.resume_model=/projectnb/cs598/students/ayak/multimodal_tests/checkpoints/Allen_CP/morphem70k/2025-Mar-15-20-58-20--seed2025/model_last.pt \
  ++train.checkpoints=/projectnb/cs598/students/ayak/multimodal_tests/checkpoints/Allen_CP \
  ++eval.dest_dir=/projectnb/cs598/students/ayak/multimodal_tests/results/Allen_CP_tests_${TIMESTAMP}/results \
  ++eval.feature_dir=/projectnb/cs598/students/ayak/multimodal_tests/features/Allen_CP_tests_${TIMESTAMP}/features \
