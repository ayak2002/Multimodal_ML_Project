...
python main.py -m -cn chammi_cfg \
  ...
  ++eval.dest_dir=/projectnb/cs598/students/ayak/multimodal_tests/results/multimodal_tests_${TIMESTAMP}/results \
  ++eval.feature_dir=/projectnb/cs598/students/ayak/multimodal_tests/features/multimodal_tests_${TIMESTAMP}/features \
