...
python main.py -m -cn chammi_cfg \
  ...
  ++train.checkpoints=/projectnb/cs598/students/ayak/multimodal_tests/checkpoints/HPA_CP \
  ++eval.dest_dir=/projectnb/cs598/students/ayak/multimodal_tests/results/HPA_CP_tests_${TIMESTAMP}/results \
  ++eval.feature_dir=/projectnb/cs598/students/ayak/multimodal_tests/features/HPA_CP_tests_${TIMESTAMP}/features \
